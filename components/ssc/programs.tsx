...
const programsTabs = [
  ...
  },
  {
    ...
    label: '전문자격준비',
    badge: '자격증·기술',
    badgeColor: 'bg-red-600/15 text-red-600 border-red-600/30 dark:bg-red-500/15 dark:text-red-400/70 dark:border-red-500/30',
    title: '공인중개사·행정사·정리사 등 전문자격 준비',
    description: [
      '공무원 시험과 달리 전문자격증은 실전 경험이 핵심입니다.',
      '강원도 강사진과 함께 이론-문제풀이-모의고사-면접까지',
      '체계적으로 준비하세요.',
    ],
    features: [
      '공인중개사·행정사·정리사 등 주요 자격증 집중 과정',
      '교시제 시간표 기반 집중 관리',
      '강원도 합격자 선배들의 학습 데이터 공유',
      '1차 필기 합격 후 실무교육 연계',
      '합격까지의 전체 일정 플래너 관리',
    ],
  },

...
const wonjuFacilities = [
  {
    id: 1,
    icon: 'BookOpen',
    image: '/images/wonju-facility-study.jpg',
    title: '개별 지정석 자습실',
  ...
  },
  {
    id: 2,
    icon: 'Users',
    image: '/images/wonju-facility-lounge.jpg',
    title: '스탠딩 라운지',
  ...
  },
  {
    id: 3,
    icon: 'Box',
    image: '/images/wonju-facility-locker.jpg',
    title: '개인 사물함 · 신발장',
  ...
  },
  {
    id: 4,
    icon: 'Coffee',
    image: '/images/wonju-facility-surroundings.jpg',
    title: '편의시설 (병원, 카페 등)',
...
export default function WonjuPage() {
  return (
    <main className="overflow-x-hidden pb-16 md:pb-0">
      ...
      <Differentiation />
      <Testimonials />
      <Facilities facilities={wonjuFacilities} />
      <Curriculum />
      <Systems />
      <Campus filter="원주" />
      <Faq />
